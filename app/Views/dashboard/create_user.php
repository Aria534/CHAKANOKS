            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="role" name="role" required>
                        ...
                        <option value="central_admin" <?= old('role') == 'central_admin' ? 'selected' : '' ?>>Central Admin</option>
                        ...
                        <option value="franchise_manager" <?= old('role') == 'franchise_manager' ? 'selected' : '' ?>>Franchise Manager</option>
