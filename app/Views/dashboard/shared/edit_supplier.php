...
<head>
    ...
    <title>Edit Supplier - ChakaNoks</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            ...
            <form action="<?= site_url('suppliers/update/' . $supplier['supplier_id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="payment_terms" name="payment_terms" 
                               value="<?= old('payment_terms', $supplier['payment_terms']) ?>" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="delivery_time" name="delivery_time" 
                               value="<?= old('delivery_time', $supplier['delivery_time']) ?>" min="1" required>
                    </div>
